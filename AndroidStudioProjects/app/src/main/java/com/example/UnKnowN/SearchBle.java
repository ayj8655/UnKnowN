...
public class SearchBle extends AppCompatActivity {
    ...
    private TextView deviceName,rssiFuck, address;
                        ...
                        if(result.getDevice().getName() !=null && result.getDevice().getName().equals("UnKnown")) {
                            ...
                            runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    rssiFuck.setText("Distance :" + " "+(Math.round(distance*10)/10.0)+" " +"(M)");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rssiFuck = (TextView) findViewById(R.id.fuck);
